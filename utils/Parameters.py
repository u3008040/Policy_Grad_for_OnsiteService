...
def parameters():
    ...
    parser.add_argument('--training_batch_size', default=4)# 训练时候的batch
    ...
    parser.add_argument('--lam', default=0.568, help='average number of arrivals per unit time')
    ...
    parser.add_argument('--entropyrate',default=0.2,type=float,help='entropy rate')
    ...
    parser.add_argument('--totaltime', default=45, type=float, help='total time interval')
    ...
    parser.add_argument('--TWlb',default=2,type=int)
    parser.add_argument('--TWub',default=4,type=int)
